...
export default function Completed({
    ...
    const completedHero =
        settings?.completed_projects_banner
            ? `/storage/${settings.completed_projects_banner}`
    ...
    return (
        <div className="min-h-screen bg-white text-[#1A1A1A] overflow-x-hidden selection:bg-amber-500 selection:text-white relative">

            <Head title={`Completed Projects | ${siteName}`} />
            ...
            <section className="relative h-[70vh] bg-black flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto mt-8 text-gray-300 leading-relaxed text-base md:text-lg">
                        A curated showcase of refined interiors, architectural excellence,
                        and timeless luxury crafted for exceptional clients.
                    </p>
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-[16/10] overflow-hidden mb-8 shadow-2xl rounded-[20px]">
                                            ...
                                            <div className="absolute top-6 left-6">
                                                ...
                                                <span className="bg-amber-500 text-white px-4 py-2 text-[9px] uppercase tracking-[0.25em] font-bold rounded-full">
                                                    {project.category || 'Luxury Interior'}
                                                </span>
                                        ...
                                        <div className="flex items-end justify-between gap-6">
                                            ...
                                            <div>
                                                ...
                                                <h3 className="text-3xl md:text-4xl font-serif mb-3">
                                                    {project.title || `Luxury Project ${projectNumber}`}
                                                </h3>
                        ...
                        >
                            ...
                            <div className="relative h-[45vh] bg-black overflow-hidden">
                                ...
                                <div className="absolute bottom-8 left-8 text-white">
                                    ...
                                    <span className="bg-amber-500 text-white px-4 py-2 rounded-full text-[9px] uppercase tracking-[0.3em] font-bold inline-block mb-5">

                                        {selectedProject.category || 'Luxury Interior'}
                            ...
                            <div className="p-8 space-y-10">
                                ...
                                <div className="bg-gray-50 border border-gray-100 rounded-[20px] p-6">
                                    ...
                                    <h4 className="uppercase tracking-[0.3em] text-[10px] text-gray-400 font-bold mb-6">
                                        Project Specifics
                                    </h4>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed text-sm md:text-base font-light">
                                        {selectedProject.description ||
                                            "This completed luxury space represents the pinnacle of bespoke design and refined craftsmanship."}
                                    </p>
            ...
            <footer className="bg-[#111111] text-white pt-28 pb-12 px-6 md:px-12 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="absolute bottom-10 left-0 w-full text-center opacity-[0.03] pointer-events-none select-none">
                        ...
                        <h1 className="text-[18vw] font-serif whitespace-nowrap leading-none">
                            {siteName}
                        </h1>
